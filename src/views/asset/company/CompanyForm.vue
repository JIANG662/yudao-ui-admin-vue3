<template>
  <Dialog :title="dialogTitle" v-model="dialogVisible">
    ...
    >
      ...
      <el-form-item label="已开通模块，逗号分隔" prop="moduleConfig">
        <el-input v-model="formData.moduleConfig" placeholder="请输入已开通模块，逗号分隔" />
      </el-form-item>
    </el-form>
    <template #footer>
...
import { CompanyApi, Company } from '@/api/asset/company'
...
const submitForm = async () => {
  ...
  formLoading.value = true
  try {
    const data = formData.value as unknown as Company
